...
#          4. repeat 2-4 for each region
#          5. calculate the difference between C_k and C_(k)
#          6. calculate difference between the two sets of estimates, diff_c_k = C_k - C_(k), calculate overall diff_c using weighted average 

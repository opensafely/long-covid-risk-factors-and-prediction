...
## Part 1. Version 11                                                         ##
#################################################################################
# Version 11: Demographics one graph; non-demographics another graph
...
v11_plot_one_cohort <- function(df,var_grp, cohort, model){
  ...
  p <- forest(
    ...
    xlab = "\nFully adjusted hazard ratio",
    theme = tm1)
  ggsave(file=paste0("v11_plot_HR_",cohort, "_", var_grp,"_", model,".svg"), 
...
cohort = "vtd"
model = "full"
v11_plot_one_cohort(df,var_grp="demographics", cohort, model)
v11_plot_one_cohort(df,var_grp="non_demographics", cohort, model)

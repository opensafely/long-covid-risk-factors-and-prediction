...
## Part 2. Version 9                                                         ##
#################################################################################
# Version 9: Demographics one graph; non-demographics another graph
...
v9_plot <- function(df,var_grp){
  ...
  ggsave(file=paste0("v9_plot_HR_",cohort, "_", var_grp,".svg"), path = paste0(output_dir, "figures"),
         plot=p, width=30, height=20)
}

v9_plot(df,var_grp="demographics")
v9_plot(df,var_grp="non_demographics")

...
* If you are interested in how we defined our variables, take a look at the [study definition for primary and pre-vaccination cohorts](analysis/study_definition_all.py), [study definition for post-vaccination cohort](analysis/study_definition_vaccinated.py), and [study definition for post-COVID cohort](analysis/study_definition_infected.py), ; these are written in `python`, but non-programmers should be able to understand what is going on there
